...
If the user filters by gender (e.g. 'mens', 'women'), you MUST check the 'title' column using pattern matching (e.g. title LIKE '%Men%' or title LIKE '%Women%').
Create a single SQL query for the question provided. 
The query should have all the fields in SELECT clause (i.e. SELECT *)
Also, ALWAYS limit the result to 5 rows (e.g. LIMIT 5) unless specified otherwise.
